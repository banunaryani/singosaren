                    ...
                    <table class="table main-table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?= $no; $no++; ?></td>
                          <td>
                            <img width="100" src="<?= base_url('assets/img/berita/').$b['gambar'] ?>"></td>
                          <td><?= $b['judul'] ?></td>
                          <td><?= $b['kategori'] ?></td>
                          ...
                          <td>
                            ...
                            <a target="_blank" href="<?= base_url('berita/').$b['slug'] ?>" class="btn btn-sm btn-light" data-toggle="tooltip" data-placement="bottom" title="Preview"><span class="fas fa-fw fa-eye"></span></a>
                          </td>
                        </tr>
                        <?php
                        }
