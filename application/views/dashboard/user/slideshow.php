          		...
          		<table class="table">
                      ...
                      <td>
          						...
          						<td>
          							...
          							<div class="row mb-2">
          								<button type="button" data-toggle="modal" data-target="#hapusModal-<?= $ss['id'] ?>" class="btn btn-sm remove <?= ($ss['urutan'] ==1 )? "btn-secondary":"btn-danger" ?>" <?= ($ss['urutan'] ==1 )? "disabled":"" ?>><span class="fas fa-fw fa-sm fa-trash"></span></button>
          							</div>
          						</td>
          					</tr>
