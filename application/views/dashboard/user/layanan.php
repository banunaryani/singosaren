    ...
    <div class="col-lg-2 col-md-2 mb-3">
      ...
      <div class="nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        ?>
          ...
          <a class="nav-link" id="v-pills-home-tab" data-toggle="pill" href="#<?= strtr(strtolower($k['kategori']), " ", "-") . '-tab' ?>" role="tab" aria-controls="<?= strtr(strtolower($k['kategori']), " ", "-")  . '-tab' ?>" aria-selected="true"><?= $k['kategori'] ?></a>
      ...
      <div class="d-flex justify-content-end">
        <a href="#" class="btn btn-sm btn-warning mx-1" data-toggle="modal" data-target="#editModal" data-toggle="tooltip" data-placement="top" title="Edit kategori"><span class="fas fa-fw fa-sm fa-pen"></span></a>
        <a href="#" class="btn btn-sm btn-primary mx-1" data-toggle="modal" data-target="#tambahModal" data-toggle="tooltip" data-placement="top" title="Tambah kategori"><span class="fas fa-fw fa-sm fa-plus"></span></a>
      </div>
    ...
    <div class="col">
      ...
      <div class="card">
        <div class="card-header d-flex bd-highlight">
          ...
          <div class="input-group p-2 bd-highlight col-sm-8 col-md-4 col-lg-3">
          ...
          <div class="p-2 bd-highlight">
            <a href="<?= base_url('admin/layanan/tambah_layanan') ?>" class="btn btn-primary"><span class="fas fa-fw fa-plus"></span>
              <p class="d-sm-none"> Tambah Layanan</p>
            </a>
          </div>
        </div>
        <div class="card-body">
          <div class="tab-content" id="v-pills-tabContent">
                ...
                <div class="card layanan_card mb-2">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-sm col-md col-lg"><?php echo '<a href=' . base_url('admin/layanan/detail/') . $l['slug'] . '>' . $l['judul'] . '</a>';
                                                        echo ($l['arsipkan'] == 1) ? '<small><span class="badge badge-secondary ml-2">Diarsipkan</span></small>' : '';
                                                        echo ($l['tampil_beranda'] == 1) ? '<small data-toggle="tooltip" title="Ditampilakan di halaman depan"><span class="badge badge-primary ml-2"><span class="fas fa-fw fa-sm fa-desktop"></span></span></small>' : '';
                                                        echo ($l['file']) ? '<small data-toggle="tooltip" title="Lampiran dokumen"><span class="badge badge-success ml-2"><span class="fas fa-fw fa-sm fa-download"></span></span></small>' : '' ?></div>
                      <div class="col-auto">
                        <a href="<?= base_url('admin/layanan/edit_layanan/') . $l['layanan_id'] ?>" class="btn btn-sm btn-warning"><span class="fas fa-fw fa-pen"></span>
                          <p class="d-sm-none d-md-none"> Edit</p>
                        </a>
                        <a href="#" data-toggle="modal" data-target="#hapusModal-<?= $l['layanan_id'] ?>" class="btn btn-sm btn-danger"><span class="fas fa-fw fa-trash"></span>
                          <p class="d-sm-none d-md-none"> Hapus</p>
                        </a>
                      </div>
                    </div>
            ...
            foreach ($kategori as $k) {
            ?>
              <div class="tab-pane fade" id="<?= strtr(strtolower($k['kategori']), " ", "-") . '-tab' ?>" role="tabpanel" aria-labelledby="v-pills-home-tab">
                <?php
                foreach ($layanan as $key => $l) {
                  $no = 1;
