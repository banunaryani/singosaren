          		...
          		<div class="row ml-1 mb-5 slideshowForm">
          			...
          			<div class="col mt-2 mx-2">
			            ...
			            <div class="col-2 mt-2 mx-2">
			            	<div class="row mb-2">
			            		<button class="btn btn-sm btn-danger remove"><span class="fas fa-fw fa-sm fa-trash"></span> Hapus</button>
			            	</div>
			            	<div class="row mb-2">
			            		<input type="hidden" id="arsipkan" name="arsipkan" value="0">
			            		<button class="btn btn-sm btn-warning" name="btnArsipkan"><span class="fas fa-fw fa-sm fa-folder-open"></span> Arsipkan</button>
			            	</div>
			            </div>
			            <!-- end kolom aksi -->
