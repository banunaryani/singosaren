          		...
          		<div class="row ml-1 mb-5 slideshowForm">
          			...
          			<div class="col mt-2 mx-2">
          				...
          				<form method="post" action="<?= base_url('user/edit_slideshow/'.$slideshow['id']) ?>" enctype="multipart/form-data">
          					...
          					<div class="row my-3">
          						<div class="col">
          							<img height="300" src="<?= base_url('assets/img/slideshow/').$slideshow['gambar'] ?>">
          						</div>
          					</div>
          					<div class="row">
          						<div class="col-6">
                      ...
                      ?>
			            ...
			            <div class="col-2 mt-2 mx-2">
			            	<div class="row mb-2">
			            		<button type="button" data-toggle="modal" data-target="#hapusModal-<?= $slideshow['id'] ?>" class="btn btn-sm btn-danger"><span class="fas fa-fw fa-sm fa-trash"></span> Hapus</button>
			            	</div>
			            	<div class="row mb-2">
			            		<input type="hidden" id="arsipkan" name="arsipkan" value="<?= $slideshow['arsipkan'] ?>">
                      <a href="<?= base_url('user/toggle_arsipkan_slideshow/').$slideshow['id']."/".$slideshow['arsipkan'] ?>" class="btn btn-sm btn-warning" id="btnArsipkan" name="btnArsipkan"><span class="fas fa-fw fa-sm fa-folder-open"></span> Diarsipkan</a>
			            	</div>
			            </div>
			            <!-- end kolom aksi -->
