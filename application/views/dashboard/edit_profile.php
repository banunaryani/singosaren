...
<div class="container-fluid">
	...
	<div class="col-lg-5">
		...
		<form method="post" action="<?= base_url('user/edit_profile/') . $this->session->userdata('id') ?>">
			<div class="form-group row">
				<label for="email" class="col-sm-3 col-form-label">ID</label>
				<div class="col-sm-9">
					<input type="text" readonly class="form-control-plaintext" id="email" value="<?= $this->session->userdata('id') ?>">
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<a href="<?= base_url('user/ubah_password/') . $this->session->userdata('id') ?>" class="btn btn-sm btn-primary"><span class="fa fa-sm fa-fw fa-pen"></span> Ubah Password</a>
				</div>
			</div>
