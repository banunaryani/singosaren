        ...
        <div class="card-body px-3">
          ...
          <form class="data-peta" method="post" action="<?= base_url('admin/peta/') ?>">
            ...
            <div class="form-group row">
              ...
              <div class="col">
                <input type="text" class="form-control" id="persil" name="persil" readonly>
              </div>
            </div>
            <div class="form-group row">
        ...
        layer.on({
          ...
          click: function(e) {
            ...
            $.post('<?= base_url('admin/peta/get_rt') ?>', {
              ...
              $('.card-body select#pilihPedukuhan option[value=' + response.dukuh + ']').attr('selected', 'selected');
        ...
        layer.on({
          ...
          click: function(e) {
            ...
            $.post('<?= base_url('admin/peta/get_persil') ?>', {
              ...
              if (response == null) {
                // code
                var content = "<table class='table table-bordered'><tbody><tr class='table-warning'><th scope='row'>Nomor</th><td>" + e.target.feature.properties.Nomor + "</td></tr><tr><th scope='row'>RT</td><td>" + e.target.feature.properties.RT + "</td></tr></tbody></table><p><span class='fa fa-exclamation-triangle'></span> Data belum tersimpan</p>";

                $('.card-body input#rt').val(rt);
                $('.card-body input#persil').val(no);
                $('.card-body input#rw').val('');
                $('.card-body input#penduduk').val('');
                $('.card-body input#luas').val('');
              } else {
                ...
                $('.card-body input#rt').val(rt);
                $('.card-body input#persil').val(no);
                $('.card-body input#rw').val(response.rw);
                $('.card-body input#penduduk').val(response.penduduk);
                $('.card-body input#luas').val(response.luas);
              }
