		...
		<div class="row">
			<div class="col-lg-12 col-12">
				<div class="call-inner text-center">
					<h2><i>"Agamis, Kuat, Maju, Damai, Sejahtera, Gotong Royong"</i></h2>
				</div>
			</div>
		</div>
	</div>
						...
						<div class="single-news ">
							...
							<div class="news-body">
								<div class="news-content">
									...
									<div class="news-text"><p><?= substr($b['konten'],0,120) ?></p></div>
									<ul class="news-meta">
		...
		<div class="row">
			<div class="col-lg-12 col-12">
				<div class="call-inner">
					<h2><i>"Rukun agawe santosa, crah agawe bubrah"</i></h2>
					<p>Hidup rukun pasti akan hidup sentosa, sebaliknya jika selalu bertikai pasti akan bercerai</p>
				</div>
			</div>
		</div>
	</div>
